...
<head>
  ...
  <title>
    OUR TEAM- DEEN BANJUS ENGINEERING LITD.
  </title>
...
<body>
  ...
  <section class="inner-intro bg-img light-color overlay-before parallax-background">
    <div class="container">
      <div class="row title">
        <div class="title_row">
          <h1 data-title="About"><span>Board of Directors</span></h1>
          <div class="page-breadcrumb"><a href="/">Home</a>/ <span>Board of Directors</span></div>
        </div>
      </div>
    </div>
  </section>
