      ...
      <div class="row">
        <div class="col-md-3 col-lg-3 mt-xs-40 pb-xs-40">
          <div class="tab-title">
            <ul class="clearfix">
              <li>
                <a href="about2.php" class="active">Company</a>
              </li>
              <li>
                <a href="history.php">History</a>
              </li>
          ...
          <div class="tab-content">
            <div class="row tab-block">
              <div class="row-table abt-block__bg">
                ...
                <div class="col-md-6 col-lg-6 no-padding t_cell">
                  <div class="abt-box__content">
                    ...
                    <a href="#" class="abt-box__content-link">
                      Read More
                      <i class="fa fa-chevron-circle-right abt-box__content-link-arrow" aria-hidden="true"></i></a>
                  </div>
                </div>
              </div>
              <div class="col-md-12 col-lg-12">
                ...
                <a href="#" class="abt-box_link">
                  Read More
                  <i class="fa fa-chevron-circle-right abt-box_link-arrow" aria-hidden="true"></i></a>
              </div>
            </div>
          </div>
                ...
                <div class="abt-block__wrap">
                  <div class="abt-block__left abt-block__bg">
                    ...
                    <p>
                      ...
                      ullamco laboris nisi aliquip exea commodo ipsum dolor
