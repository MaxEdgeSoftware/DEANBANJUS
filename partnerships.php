        ...
        <div class="col-md-3 col-lg-3 mt-xs-40 pb-xs-40">
          <div class="tab-title">
            <ul class="clearfix">
              ...
              <li>
                <a href="partnerships.php" class="active">Partnerships</a>
              </li>
              <li>
                <a href="leadership.php">Leadership</a>
              </li>
              ...
              <div class="col-md-9 col-lg-9 no-padding t_cell">
                <div class="partner__content partnership">
                  ...
                  <a href="#" class="abt__link">
                    Read More
                    <i class="fa fa-chevron-circle-right abt__link-arrow" aria-hidden="true"></i></a>
                </div>
              </div>
            </div>
