        ...
        <div class="col-lg-4 col-sx-12">
          <div class="single-sidebar-widget">
            <div class="special-links">
              <ul>
                <li>
                  <a class="active" href="#">Construction Management</a>
                </li>
          ...
          <div class="single-sidebar-widget">
            ...
            <ul class="brochure-btns">
              <li>
                <a href="#" class="clearfix"><i class="fa fa-file-pdf-o"></i>
          ...
          <div class="text-box mt-40">
            ...
            <div class="text-content">
              <p>
                ...
                suscipit eget Aenean suscipit eget mi act fermentum phasellus
            ...
            <div class="row mt-45 clearfix">
              ...
              <div class="col-md-7 text-box">
                ...
                <div class="text-content">
                  <p>
                    Aenean suscipit eget mi act fermentum phasellus vulputate
                    turpis tincidunt. Aenean suscipit eget.. Aenean suscipit
                    eget mi act fermentum phasellus vulputate turpis
                    tincidunt. Aenean suscipit eget Aenean suscipit eget mi
                    act fermentum phasellus vulputate turpis tincidunt. Aenean
                    suscipit eget..
                  </p>
                </div>
              </div>
