    ...
    <div class="container">
      <div class="row title">
        <div class="title_row">
          ...
          <div class="page-breadcrumb"><a>Home</a>/ <span>History</span></div>
        </div>
      </div>
    </div>
  </section>
            ...
            <div class="row">
              ...
              <div class="col-md-12 col-lg-12">
                ...
                <p>
                  ...
                  nisi aliquip exea commodo ipsum dolor sit amet consectetur
                  adipisicing elit eiusmod tempor incididunt ut labore et
                  dolore magna aliqua. laboris nisi aliquip exea commodo ipsum
            ...
            <div class="history-timeline__block">
              <ul class="history-timeline">
                <li>
                  ...
                  <p class="date text-block text-bold m-b-30">2012</p>
                    ...
                    <div class="abt-block__wrap">
                      <div class="abt-block__left abt-block__bg">
                        ...
                        <p>
                          ...
                          exercitation ullamco laboris nisi aliquip exea
                          commodo ipsum dolor sit amet consectetur adipisicing
                          elit eiusmod tempor incididunt ut labore et dolore
                          magna aliqua.
                        </p>
                        <a href="#" class="abt-block_link">
                          Read More
                          <i class="fa fa-chevron-circle-right abt-block_link-arrow" aria-hidden="true"></i></a>
                      </div>
                ...
                <li>
                  ...
                  <div class="mv-block">
                    <div class="mv-block__mission mv-block__mission-bg">
                      ...
                      <a href="#" class="mv-block__mission_link">
                        Read More
                        <i class="fa fa-chevron-circle-right mv-block__mission_link-arrow" aria-hidden="true"></i></a>
                    </div>
                    <div class="mv-block__vision mv-block__vision-bg">
                      <h3>Our vision</h3>
                      <p>
                        Lorem ipsum dolor sit amet consectetur adipisicing
                        elit eiusmod tempor incididunt ut labore et
                      </p>
                      <a href="#" class="mv-block__vision_link">
                        Read More
                        <i class="fa fa-chevron-circle-right mv-block__vision_link-arrow" aria-hidden="true"></i></a>
                    </div>
                  </div>
                </li>
                <li>
