            ...
            <div class="col-md-12 col-lg-12 blog-post-hr">
              <div class="blog-post mb-45">
                ...
                <div class="post-header">
                  <h2>
                    <a href="blog-detail.php">Maecenas nec odio ante varcy tincidunt</a>
                  </h2>
                </div>
                ...
                <div class="post-more-link pull-left">
                  <a href="blog-detail.php" class="btn-text">Read More</a>
                </div>
              </div>
              <hr />
              <div class="blog-post mb-45">
                <div class="post-media">
                  <img src="assets/images/blog/img3.jpg" alt="" /><span class="event-calender blog-date">
                    21 <span>june</span>
                  </span>
                </div>
                <div class="post-meta">
              ...
              <div class="blog-post mb-45">
                <div class="post-media">
                  <blockquote class="dark-bg">
                    ...
                    crash-test dummy behind, We're not leaving here without
                    Buster, man. Leave no crash-test dummy behind nihil
