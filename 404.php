...
<body>
  ...
  <section class="inner-intro bg-img light-color overlay-before parallax-background">
    <div class="container">
      <div class="row title">
        <div class="title_row">
          <h1 data-title="404 apge"><span>404 apge</span></h1>
          <div class="page-breadcrumb">
            <a>Home</a>/ <span>404 apge</span>
          </div>
        </div>
      </div>
    </div>
  ...
  <!-- CONTENT -->
  <div class="page-404 ptb-80 ptb-xs-40">
    <div class="container">
      <!--Footer Info -->
      <div class="row text-center">
        <div class="col-md-6 col-lg-6 offset-md-3">
          ...
          <p>
            ...
            Repudiandae odit iste exerc ssumenda voluptas quidem sit maiores
            odio velit voluptate.
          </p>
          <a href="index1.php" class="btn-text mt-15">Back to home page</a>
        </div>
      </div>
    </div>
  </div>
